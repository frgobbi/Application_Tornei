...
try{
    $connessione->exec("INSERT INTO `partita`(`id_partita`, `data_partita`, `ora_partita`, `luogo`, `fase_finale`) VALUES (NULL,'$data','$ora','$luogo','0')");
    $ogg_p = $connessione->query("SELECT MAX(id_partita) AS id_partita FROM `partita` WHERE 1")->fetch(PDO::FETCH_OBJ);
    $connessione->exec("INSERT INTO `sq_partita`(`id_sq`, `id_partita`, `vittoria`, `sconfitta`, `pareggio`, `sconfitta_punti`) VALUES ('$sq1','$ogg_p->id_partita','0','0','0','0')");
    $connessione->exec("INSERT INTO `sq_partita`(`id_sq`, `id_partita`, `vittoria`, `sconfitta`, `pareggio`, `sconfitta_punti`) VALUES ('$sq2','$ogg_p->id_partita','0','0','0','0')");
