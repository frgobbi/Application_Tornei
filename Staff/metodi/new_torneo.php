...
try{
    $sql_new_torneo ="INSERT INTO `torneo`(`id_torneo`, `nome_torneo`, `id_sport`, `min_sq`, `max_sq`, `num_giocatori`, `data_inizio`, `data_f_iscrizioni`, `data_fine`, `min_anno`, `max_anno`, `logo_torneo`, `color`, `info`, `finished`) VALUES "
        ."(NULL, '$nome_torneo', '$Sport', '$min_squadre', '$max_squadre', '$num_sq', '$data_inizio', '$data_fine_iscrizioni', '$data_fine', '$eta_min','$eta_max', 'logo_tornei.png', NULL, '$info', '0');";
